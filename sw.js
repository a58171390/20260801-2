...
const STATIC_CACHE = `drink-static-${VERSION}`;
const CDN_CACHE = `drink-cdn-${VERSION}`;
const IMG_CACHE = `drink-img-${VERSION}`;
...
const PRECACHE_URLS = [
  ...
  './offline.html',
  './favicon.ico',
  './images/hero-brown-sugar.jpg',
  './images/product-grapefruit.jpg',
